      ...
      <div className=" mx-auto ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link key={index} href={`/rooms/${room.id}`}>
              <div className="flex flex-col gap-4 group cursor-pointer">
                ...
                <div className="flex justify-between items-start px-1">
                  <h3 className="font-bold text-black text-lg group-hover:underline">{room.title}</h3>
          ...
          <Link href="/rooms/5" className="col-span-1 md:col-span-2 block">
            <div className="bg-gray-50 rounded-3xl overflow-hidden flex flex-col md:flex-row p-8 gap-6 shadow-sm h-full group cursor-pointer hover:bg-gray-100 transition-colors">
              <div className="flex-1 flex flex-col justify-center space-y-6">
                ...
                <div className="pt-2">
                  <span className="inline-flex items-center text-black font-medium group-hover:opacity-70 transition-opacity">
                    Explore More
                    <span className="ml-2 bg-black text-white rounded-full p-1 group-hover:bg-blue-600 transition-colors">
