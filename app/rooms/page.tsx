...
export default function RoomsPage() {
    ...
    const categories = ['All', 'Deluxe', 'Superior', 'Executive', 'Royal Suite', 'Business Class', 'Platinum'];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative w-full py-32 bg-white flex flex-col items-center justify-center overflow-hidden">
                ...
                <h1 className="text-5xl md:text-9xl font-bold text-black mb-4 tracking-tighter lowercase">
                    rooms
                </h1>
            ...
            <section className="w-full bg-white pb-32">
                <div className=" mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Main Container */}
                    <div className="bg-[#111] rounded-3xl md:rounded-[3rem] p-6 md:p-12 min-h-[800px]">

                        {/* Tabs */}
                        <div className="flex flex-wrap items-center justify-center gap-4 mb-16 border-b border-gray-800 pb-8">
                            {categories.map((cat) => (
                                <button
                                    key={cat}
                        ...
                        <div className="mt-20 flex justify-center">
                            <button className="px-8 py-4 rounded-full border border-gray-700 text-white font-bold hover:bg-white hover:text-black transition-all">
                                Load More Rooms
                            </button>
                        </div>
